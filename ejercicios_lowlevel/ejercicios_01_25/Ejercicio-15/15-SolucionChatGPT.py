...
# Luego, se inicializa la variable suma en cero.
suma = 0
# Se utiliza un ciclo for para recorrer todos los números enteros positivos desde 1 hasta n. La función range(1, n+1) genera un rango que va desde 1 hasta n (incluyendo n).
